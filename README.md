...
This readme consists of two parts: (1) [use with docker](https://github.com/chenste/autonomy_stack/blob/master/README.md#-part1-use-with-docker) and (2) [use without docker](https://github.com/chenste/autonomy_stack/blob/master/README.md#-part2-use-without-docker).
...
```
cd ~ (or your desired place to put autonomy_stack code)
git clone https://github.com/chenste/autonomy_stack.git
cd autonomy_stack
git checkout origin/state_machine_update
```

Secondly, go to arl-unity-ros, create symbolic links and build:
```
