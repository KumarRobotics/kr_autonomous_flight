...
#include <kr_planning_msgs/msg/primitive_array.hpp>
...
kr_planning_msgs::msg::Trajectory toTrajectoryROSMsg(
    const MPL::Trajectory2D &traj, double z = 0);
...
MPL::Trajectory2D toTrajectory2D(
    const kr_planning_msgs::msg::Trajectory &traj_msg);
