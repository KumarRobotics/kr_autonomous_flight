...
TEST_F(VoxelMapperTest, TestAllocateRelocate) {
  ...
  kr_planning_msgs::msg::VoxelMap relocated_map = p_test_mapper_->getMap();

  // Create the ground truth voxel map to compare it to the relocated map
  kr_planning_msgs::msg::VoxelMap gt_voxel_map;
...
TEST_F(VoxelMapperTest, TestSetMapUknown) {
  ...
  kr_planning_msgs::msg::VoxelMap vox_map = p_test_mapper_->getMap();
  kr_planning_msgs::msg::VoxelMap inflated_vox_map =
...
TEST_F(VoxelMapperTest, TestDecayLocalCloud) {
  ...
  kr_planning_msgs::msg::VoxelMap decayed_map = p_test_mapper_->getMap();
...
TEST_F(VoxelMapperTest, TestAddCloud) {
  ...
  p_test_mapper_->addCloud(lidar_points, t_map_lidar, neighbors, false,
                            max_range);
  kr_planning_msgs::msg::VoxelMap processed_map = p_test_mapper_->getMap();
  kr_planning_msgs::msg::VoxelMap processed_inflated_map;
  ...
  // inflated map
  kr_planning_msgs::msg::VoxelMap gt_voxel_map;
  kr_planning_msgs::msg::VoxelMap gt_inflated_voxel_map;
...
TEST_F(VoxelMapperTest, TestGetInflatedMap) {
  kr_planning_msgs::msg::VoxelMap normal_map = p_test_mapper_->getMap();
  kr_planning_msgs::msg::VoxelMap inflated_map = p_test_mapper_->getInflatedMap();
...
TEST_F(VoxelMapperTest, TestGetInflatedLocalMap) {
  ...
  kr_planning_msgs::msg::VoxelMap local_map;
...
TEST_F(VoxelMapperTest, TestgetInflatedOccMap) {
  ...
  kr_planning_msgs::msg::VoxelMap sliced_map =
    p_test_mapper_->getInflatedOccMap(1.25, 2.25);

  // Create the ground truth voxel map
  kr_planning_msgs::msg::VoxelMap gt_slice;
  int x_dim = x_dim_ / resolution_;
  int y_dim = y_dim_ / resolution_;
