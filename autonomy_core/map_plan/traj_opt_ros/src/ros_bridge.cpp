...
TrajRosBridge::TrajRosBridge() {
  node_ = std::make_shared<rclcpp::Node>("traj_ros_bridge");
  pub_ = node_->create_publisher<kr_planning_msgs::msg::SplineTrajectory>(
...
void TrajRosBridge::publish_msg(
    const kr_planning_msgs::msg::SplineTrajectory &msg, std::string frame_id) {
