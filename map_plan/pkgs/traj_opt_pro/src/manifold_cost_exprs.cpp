...
NestedSO3::NestedSO3(const Quat &R1,const Quat &R2,const std::vector<boost::shared_ptr<NestedExpression> > &xi1, int d) {
  f_inputs = xi1;
  dq = R2.inverse()*R1;
  dim = d;
}
decimal_t NestedSO3::f(const std::vector<decimal_t> &x) {
  Vec3 xi; xi << x.at(0),x.at(1),x.at(2);
...
double NestedS2CostPart::f(const std::vector<decimal_t> &val) {
  ...
  double t139 = t140*(t115-c0_1*t49-c0_6*t105+c0_3*(t109+t110-t*t2*t6*7.8E2-t*t3*t11*4.2E2)+c0_2*(t111+t112-t*t2*t6*9.0E2-t*t3*t11*4.2E2)+c0_7*(t38-t46+t106-t*t2*t4*1.0E1)+c0_5*(t13+t107-t2*t4*3.0E1-t3*t6*1.95E2)-c0_4*(t13+t108-t2*t4*6.0E1-t3*t6*2.25E2+1.0))*2.0+t16*t104*(t160+t162+t166+t45*(t141-t142-t144+t146-t147+t148+c1_2*t130+c1_3*t129)*2.0)*2.0-t16*t167*t168*4.0+t103*t104*(t16*t103*2.0+t45*(t124+t125+t126+t127+c1_0*t63-c1_1*t63+c1_3*t101+c1_7*t98)*2.0)*4.0;
  ...
  double t169 = t140*t158*2.0-t45*t104*(t160+t162+t166+t170)*2.0-t104*t128*t138*4.0+t45*t167*t168*4.0;
  double t171 = t167*t168*4.0-t104*(t160+t162+t170+t16*(-t115+t151-t152-t153+t154+t155+c0_3*(t81-t109-t110+t120)+c0_2*(t81-t111-t112+t121))*2.0)*2.0;
