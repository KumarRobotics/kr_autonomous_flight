...
planning_ros_msgs::Trajectory toTrajectoryROSMsg(const MPL::Trajectory3D &traj);
...
MPL::Trajectory2D toTrajectory2D(const planning_ros_msgs::Trajectory &traj_msg);

/// ROS message to Trajectory3D class
MPL::Trajectory3D toTrajectory3D(const planning_ros_msgs::Trajectory &traj_msg);
