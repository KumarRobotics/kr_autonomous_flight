...
inline bool CheckPointInBox(Vec3f B1, Vec3f B2, Vec3f P1) {
  if (P1[0] > B1[0] && P1[0] < B2[0] && P1[1] > B1[1] && P1[1] < B2[1] && P1[2] > B1[2] &&
      P1[2] < B2[2]) {
    return true;
  } else {
    return false;
...
inline int GetIntersection(float fDst1, float fDst2, Vec3f P1, Vec3f P2,
                           Vec3f &Hit) {
...
inline bool IntersectLineBox(Vec3f B1, Vec3f B2, Vec3f L1, Vec3f L2, Vec3f &Hit) {
